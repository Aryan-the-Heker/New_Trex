...
function spawnObstacles(){
 if (frameCount % 60 === 0){
   var obstacle = createSprite(windowWidth / 2,windowHeight - 12,10,40);
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
     cloud = createSprite(windowWidth / 2,windowHeight - 70,40,10);
    cloud.y = Math.round(random(700,1000));
...
function setup(){
  ...
  box = new Box(200,200,10,10,2)

  box1 = new Box(200,200,10,10,-2)
}
